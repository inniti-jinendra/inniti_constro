...
class SignUpFormPhone extends StatefulWidget {
  const SignUpFormPhone({super.key});
...
class _SignUpFormPhoneState extends State<SignUpFormPhone> {
  ...
  //     CustomSnackbar.show(context, message: 'Please enter mobile ');
  //     return;
  //   }
  //
  ...
  //     } else if (user != null && user.authorizedUser) {
  //       Navigator.pushNamed(context, AppRoutes.numberVerification, arguments: user);
  //     } else {
  //       // 🚩 Handle unauthorized users
  //       CustomSnackbar.show(context, message: 'Unauthorized user');
  //     }
  //
  //   } catch (e) {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // ),
            const SizedBox(height: AppDefaults.padding),
            SignUpButton(onPressed: _verifyPhoneNumber),
