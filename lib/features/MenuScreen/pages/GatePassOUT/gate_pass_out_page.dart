...
class GatePassOUTPage extends StatelessWidget {
  const GatePassOUTPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      // appBar: AppBar(title: Text("GatePassInPage")),
      ...
      body: Center(child: Text("GatePassOutPage"),),);
  }
}
