...
import 'live_time_provider_only_attendance.dart';
import 'map_screen_attedance_only.dart';

class AttendanceOnly extends ConsumerStatefulWidget {
  const AttendanceOnly({Key? key}) : super(key: key);

  @override
  ConsumerState<AttendanceOnly> createState() =>
      _AttendanceOnlyState();
}
        ...
        child: Column(
          children: [
            Row(
              children: [
                SvgPicture.asset(
                  'assets/icons/attendance_only/calendar.svg',
                ...
                Spacer(),
                SvgPicture.asset(
                  'assets/icons/attendance_only/clock.svg', // Path to your SVG file
                  height: 24, // Set the desired size
                  width: 24, // Set the desired size
                ),
                SizedBox(width: 8),
