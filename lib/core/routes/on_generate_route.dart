...
import 'package:inniti_constro/views/profile/assigned_items_page.dart';
import 'package:inniti_constro/views/profile/salary_slip_page.dart';
import 'package:inniti_constro/views/purchase_requisition/pr_grid_page.dart';

import '../../views/attendance/self_attendance.dart';
import '../../views/auth/Un_Used_auth_files/forget_password_page.dart';
import '../../views/auth/ERP_intro_login_page.dart';
import '../../views/auth/Un_Used_auth_files/login_or_signup_page.dart';
import '../../views/auth/Un_Used_auth_files/login_page.dart';
import '../../views/auth/ERP_number_verification_page.dart';
import '../../views/auth/Un_Used_auth_files/password_reset_page.dart';
import '../../views/auth/ERP_sign_up_page.dart';
...
import '../../views/home/components/ERP_dpr_entry.dart';
...
import '../../views/labour/labour_grid_page.dart';
import '../../views/labour/labour_master_screen.dart';
...
import '../../views/purchase_requisition/pr_master_page.dart';
  ...
  static Route? onGenerate(RouteSettings settings) {
    ...
    switch (route) {
      ...
      case AppRoutes.selfAttendance:
        return CupertinoPageRoute(builder: (_) => const SelfAttendance());
