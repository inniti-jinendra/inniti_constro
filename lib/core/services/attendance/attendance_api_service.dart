...
// import '../../models/attendance_only/emp_attendance.dart';
// import '../../models/attendance_only/self_attendance_data.dart';
...
class SelfAttendanceApiService {
  static Future<List<SelfAttendanceData>> fetchSelfAttendanceData() async {
    try {
      ...
      final Uri apiUrl = Uri.parse(ApiEndpoints.fetchSelfAttendanceData);
